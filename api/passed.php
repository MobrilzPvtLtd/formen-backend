...
$action = $dating->query("SELECT GROUP_CONCAT(profile_id) as liked_profile_id from tbl_action where action='UNLIKE' and uid=".$uid."")->fetch_assoc();
...
$returnArr = array("ResponseCode"=>"200","Result"=>"true","ResponseMsg"=>"Home Data Get Successfully!!!","passedlist"=>$user);	
} else {
