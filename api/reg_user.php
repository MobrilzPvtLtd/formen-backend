...
else
{
	...
	$ccode = isset($_POST['ccode']) ? strip_tags(mysqli_real_escape_string($dating,$_POST['ccode'])) :''; 
   // $ccode = strip_tags(mysqli_real_escape_string($dating,$_POST['ccode'])) ?? null;
	...
	$search_preference = isset($_POST['search_preference']) ? strip_tags(mysqli_real_escape_string($dating,$_POST['search_preference'])) : '';
	$radius_search = isset($_POST['radius_search']) ? strip_tags(mysqli_real_escape_string($dating,$_POST['radius_search'])) : '';
	$relation_goal = isset($_POST['relation_goal']) ? strip_tags(mysqli_real_escape_string($dating,$_POST['relation_goal'])) : '';
	$profile_bio = isset($_POST['profile_bio']) ? strip_tags(mysqli_real_escape_string($dating,$_POST['profile_bio'])) : '';
	$interest = isset($_POST['profile_bio']) ? $_POST['interest'] : '';
	
	$language = isset($_POST['language']) ? $_POST['language'] : '';
    $password = strip_tags(mysqli_real_escape_string($dating,$_POST['password']));
    $refercode = isset($_POST['refercode']) ? strip_tags(mysqli_real_escape_string($dating,$_POST['refercode'])) : '';
	$gender = isset($_POST['gender']) ? strip_tags(mysqli_real_escape_string($dating,$_POST['gender'])) : '';
	$lats = $_POST['lats'];
	$longs = $_POST['longs'];
